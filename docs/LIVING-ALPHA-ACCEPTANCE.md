...
- Closed LCA-2 packets: older-world Durable Object load (Noema #565, closes #553), isolated rollback rehearsal (Noema #562, closes #555), pin-on-publish automation (Noema #567), and the hosted connect cross-tab repair (Noema #563).
- Remaining LCA-2 prerequisites: operator device enrollment (live `players` 0; in-flight Noema #561, noema-client #24).
