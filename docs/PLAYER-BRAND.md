...
Public `/watch` impressiveness is a unique blend: MUD theater, living-stage MAP, civilization sports (Who / Where / Consequence, no KPI or esports HUD), and a chamber that never pretends to be omniscient. Not pure cinema. Not a raw MUD dump. Feel is **legible but with edges of experimental**: Gate D five slots, camera-to-action, and TEXT stay non-negotiable; uncanny depth, odd marks, and withheld-as-aesthetic stay fringe; muddy hierarchy, illegible type, and cosplay HUD remain defects. Direction: *a text civilization you spectate like a match, through a chamber that never pretends to be omniscient.* Visual grammar: [WATCH-VISUAL-DIRECTION.md](WATCH-VISUAL-DIRECTION.md) §1.
