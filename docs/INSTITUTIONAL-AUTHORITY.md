...
Governance-pattern research assimilation is integrated in
[RESEARCH-ASSIMILATION-2026-08-21.md](RESEARCH-ASSIMILATION-2026-08-21.md).
Councils, oligarchies, charters, rotating offices, confederations, and
fragmented authority remain configurations of bounded offices, succession,
agreements, territory, access, and enforcement—not a new `government` entity.
