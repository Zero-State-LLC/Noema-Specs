...
Current state: LCA-0 is complete as the direction package. LCA-1 is ACTIVE_INTEGRATION. Noema PR #551 and Noema PR #552 are Gate A candidate evidence only. **Gate A is not complete.** Remaining LCA-2 prerequisites are operator enrollment, an older-world Durable Object load fixture (Noema #565 onto main; #557 remains current-shaped), isolated rollback rehearsal, pin-on-publish automation, and the repaired connect flow (Noema #563 onto main). LCA-2 remains BLOCKED. Gate C remains unproven. Do not merge Specs #291 until those prerequisites have acceptance evidence.
