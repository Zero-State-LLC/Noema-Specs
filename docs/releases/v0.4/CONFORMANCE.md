...
`conformance/v0.4/` contains 110 atomic cases, five each for L01–L22. It requires the v0.3 Observatory suite and retains C/F/O/S prerequisites. The family map is L01 identity, L02 validation, L03 fork integrity, L04 fork points, L05 interventions, L06 perturbations, L07 ablations, L08 lesions, L09 counterfactuals, L10 seed policy, L11 controls, L12 shams, L13 run identity, L14 outcomes, L15 confounds, L16 replication, L17 generalization, L18 nondeterminism, L19 audit, L20 isolation, L21 retained null/failure evidence, L22 Compiler handoff.

The validator checks fixture schemas, negative fixtures, no production mutation, source/fork digest stability, required control downgrade, unsupported lesion behavior, counterfactual completeness, and handoff semantics.
