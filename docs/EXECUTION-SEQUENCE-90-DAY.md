...
3. Complete a four-hour run with external agents and planned recovery under [LCA-GATE-E-SCENARIO.md](LCA-GATE-E-SCENARIO.md).
4. Complete a 24-hour candidate run after the four-hour gate passes under [LCA-GATE-E-SCENARIO.md](LCA-GATE-E-SCENARIO.md).
