...
LOOK currently advertises: LOOK, MOVE, INSPECT, REPAIR (+overhaul), HARVEST, TRADE*, WAIT, MESSAGE, ORG_CREATE/INVITE/LEAVE, office create/assign/vacate/act, FOCUS.
...
**Agent BUILD/CONTEST/AGREEMENT/ACCESS/ATTEST affordances** (item 1), starting with CONSTRUCT + ATTEST: already in the reducer, already frozen-verb-safe, highest RFC-0120 leverage.
