...
Current implementation-plane status is machine-readable in [`current-state.v1.yaml`](../specs/current-state.v1.yaml). Promotion and terminology are governed by [DIRECTION-AUTHORITY.md](DIRECTION-AUTHORITY.md). Acceptance and sequencing are [LIVING-ALPHA-ACCEPTANCE.md](LIVING-ALPHA-ACCEPTANCE.md), [LCA2 Gate B preparation](LCA2-GATE-B-PREPARATION.md), [LCA-GATE-C-SCENARIO.md](LCA-GATE-C-SCENARIO.md), [LCA-GATE-D-SCENARIO.md](LCA-GATE-D-SCENARIO.md), [LCA-GATE-E-SCENARIO.md](LCA-GATE-E-SCENARIO.md), and [EXECUTION-SEQUENCE-90-DAY.md](EXECUTION-SEQUENCE-90-DAY.md). Residual contract truth is tracked without thawing freezes in [SPEC-GAP-REGISTER-2026-08-25.md](SPEC-GAP-REGISTER-2026-08-25.md).
