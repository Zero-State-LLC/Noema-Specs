...
| A4 | LCA Gate D | WATCH legibility under real multi-agent pressure is unproven. | `RUNTIME_ONLY` | Blocks Gate D | [LCA-GATE-D-SCENARIO.md](LCA-GATE-D-SCENARIO.md) | Blind-review WATCH capture from Gate C evidence | private state leak, invented motives, research UI substitution |
