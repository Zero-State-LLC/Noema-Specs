...
| [RFC-0129](RFC-0129-crime-detected-payload-reconciliation.md) | **Draft** | Reconcile `CRIME_DETECTED` payload with the Accepted GC3 and RFC-0094 contracts; closes `B7a`; no producer, no `event-catalog/0.3` |
