...
- [x] RFC-0125 **Accepted**: GC9-S2 practice inheritance and schism. Derived marks only — a co-practitioner is not an heir; a difference between accounts is not a division among practitioners. No deity, belief meter, or procedural lore. Runtime gated on acceptance.
